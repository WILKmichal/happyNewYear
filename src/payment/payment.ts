interface PaymentRequest {
     ...
     * This method must be called as the result of a user interaction .
     */
    show(): void;
  ...
  interface PaymentRequestUpdateOptions {
     ...
     */
    currency?: string;    //Currency signifie devise

    /**
     * This `PaymentRequestItem` is shown to the customer in the browser’s payment interface.
     */
    total?: PaymentRequestItem;           //Demande de paiement au client
  ...
  interface PaymentRequestOptions {
     ...
     *
     * it's highly recommend  collect at least one of name, email, or phone as this also results in collection of billing address for Apple Pay.
  ...
  interface PaymentRequestItem {
     ...
     */
    pending?: boolean;              // Possibilié d'attendre à la fin pour confirmer le paiement
  }

  /**
   * The `ShippingOption` object describes a shipping method used with a `PaymentRequest`. (Partie facture, confirmation paiement)
   */
